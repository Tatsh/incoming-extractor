...
_SNAPSHOT_FIELDS: tuple[tuple[int, str, str, int], ...] = (
    ...
    (0x00948, 'userCameraMatrix', 'i', 1),
    (0x00978, 'cellArray', 'I', 1),
    ...
    (0x00dac, 'worldPoolConfigA', 'I', 1),
    (0x00ddc, 'worldPoolConfigB', 'I', 1),
    ...
    (0x68c90, 'missionScriptDataPool', 'B', 1),
    (0x80c90, 'scriptDataBuffer', 'B', 1),
