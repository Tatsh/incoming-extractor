...
1. Run `uv run pytest --cov incoming_extractor --cov-branch --cov-report term-missing:skip-covered`
...
4. Run `uv run pytest --cov incoming_extractor --cov-branch --cov-report term-missing:skip-covered`
