...
You write comprehensive pytest test suites for incoming-extractor. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('incoming_extractor.commands.module.some_function')
